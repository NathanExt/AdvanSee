import threading, os, subprocess, ctypes, tkinter, time, schedule, logging, wmi
...
# =======   CONSTANTES =======
URL_CHECKIN         = "http://127.0.0.1:5000/checkin"
...
# =======   ÍCONES =======
IMAGE_ICON_NORMAL   = Image.open(caminho_relativo("imagens", "ICON_ADVANSEE_branco.png"))
IMAGE_ICON_CHECKIN  = Image.open(caminho_relativo("imagens", "ICON_ADVANSEE_azul.png"))
CREATE_NO_WINDOW    = subprocess.CREATE_NO_WINDOW 

# =======   SERVIDOR =======
AGENT_LISTEN_PORT = 60000  # Porta que o agente vai escutar
ALLOWED_SERVER_IP = "127.0.0.1"  # IP do servidor que tem permissão para se conectar
...
class AGENTE:
    ...
    def get_installed_software(self):
        ...
        if platform.system() == 'Windows':
            try:
                cmd = 'Get-WmiObject -Class Win32_Product | Select-Object Name, Version, Vendor | ConvertTo-Json'
                ...
                if result.returncode == 0 and result.stdout:
                    ...
                    if isinstance(software_data, list):
                        software_list = software_data[:50]  # Limitar a 50 itens
                    elif isinstance(software_data, dict):
                        software_list = [software_data]

            except Exception as e:
                logging.error(f"Erro ao listar software instalado: {e}")
