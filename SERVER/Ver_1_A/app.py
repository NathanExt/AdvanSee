...
#PMOC
from modulos.pmoc.pmoc_models.pmoc_database import db_pmoc
...
app.secret_key = 'advansee_pmoc_secret_key_2025'

#app.config['DATABASE_URL_DEFAULT'] = CONFIG.DATABASE_URL_DEFAULT
#app.config['DATABASE_URL_PMOC'] = CONFIG_PMOC.DATABASE_URL_PMOC

app.config['SQLALCHEMY_DATABASE_URI'] = CONFIG.DATABASE_URL_DEFAULT
app.config['SQLALCHEMY_BINDS'] = {
    'pmoc': CONFIG_PMOC.DATABASE_URL_PMOC
}

app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False

db.init_app(app)
db_pmoc.init_app(app)
