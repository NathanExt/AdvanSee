...
from routes.rotas_site import rt_teste, rt_assets, rt_asset_categories, rt_asset_detail, rt_organizations, rt_vulnerabilities, rt_patches, rt_software, rt_vendors, rt_locations, rt_users, rt_pmoc, rt_asset_vulnerabilidades, rt_pmoc_search
...
app.register_blueprint(rt_teste.bp_teste)
